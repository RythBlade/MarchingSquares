...
namespace MarchingSquaresUI
{
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            marchingSquaresControl.DisplayDensityField = displayDensityCheckBox.Checked;

            displayLinesCheckBox.Checked = marchingSquaresControl.DisplayGeneratedLines;
            displayGridCheckBox.Checked = marchingSquaresControl.DisplayGrid;
            displayParticlesCheckBox.Checked = marchingSquaresControl.DisplayParticles;
            displayDensityPointsCheckBox.Checked = marchingSquaresControl.DisplayDensityPoints;
        }
        ...
        private void displayDensityCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            marchingSquaresControl.DisplayDensityField = displayDensityCheckBox.Checked;
        }

        private void displayLinesCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            marchingSquaresControl.DisplayGeneratedLines = displayLinesCheckBox.Checked;
        }

        private void displayGridCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            marchingSquaresControl.DisplayGrid = displayGridCheckBox.Checked;
        }

        private void displayParticlesCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            marchingSquaresControl.DisplayParticles = displayParticlesCheckBox.Checked;
        }

        private void displayDensityPointsCheckBox_CheckedChanged(object sender, EventArgs e)
        {
            marchingSquaresControl.DisplayDensityPoints = displayDensityPointsCheckBox.Checked;
        }
    }
}
