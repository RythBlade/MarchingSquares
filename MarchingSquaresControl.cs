...
namespace MarchingSquaresUI
{
    public partial class MarchingSquaresControl : UserControl
    {
        ...
        private bool displayDensityField;
        private bool displayGeneratedLines;
        private bool displayGrid;
        private bool displayParticles;
        private bool displayDensityPoints;

        public bool DisplayDensityField { get { return displayDensityField; } set { displayDensityField = value; Invalidate(); } }
        public bool DisplayGeneratedLines { get { return displayGeneratedLines; } set { displayGeneratedLines = value; Invalidate(); } }
        public bool DisplayGrid { get { return displayGrid; } set { displayGrid = value; Invalidate(); } }
        public bool DisplayParticles { get { return displayParticles; } set { displayParticles = value; Invalidate(); } }
        public bool DisplayDensityPoints { get { return displayDensityPoints; } set { displayDensityPoints = value; Invalidate(); } }
        ...
        public MarchingSquaresControl()
        {
            ...
            displayGeneratedLines = true;
            displayGrid = true;
            displayParticles = true;
            displayDensityPoints = true;
        }
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (DisplayDensityField) { RenderDensityField(e); }
            if (DisplayGrid) { RenderGrid(e); }
            if (DisplayDensityPoints) { RenderDensityPoints(e); }
            if (DisplayParticles) { RenderParticles(e); }
            if (DisplayGeneratedLines) { RenderExtractedLines(e); }
        }
